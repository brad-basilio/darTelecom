...
<main class="bg-white w-screen max-w-[100vw] lg:w-full overflow-x-hidden ">
    ...
    <section class=" lg:mt-32 bg-colorBackgroundAzul " data-aos="fade-down" data-aos-offset="150"
        ...
        <div class=" relative ">
            ...
            <div class="  relative z-10 lg:hidden ">
                ...
                <img src="{{ asset($home->imageNewsletter) }}" alt=""
                    class="  w-[343] h-[370px] md:w-[450] md:h-auto  object-cover justify-self-start " loading="lazy" />
    ...
    <section class="py-16 bg-white" data-aos="zoom-up" data-aos-offset="150" data-aos-duration="1000"
        ...
        <div class="w-11/12 lg:max-w-7xl mx-auto">
            ...
            <div class="hidden  lg:grid grid-cols-2 gap-8 mt-8 items-start" data-aos="fade-up" data-aos-offset="150"
                data-aos-duration="1000" data-aos-delay="200">
                <!-- Blog Card 1 -->
                    ...
                    @if ($mostRecentPost)
                        <a href="{{ route('detalleBlog', $mostRecentPost->slug) }}">
                            <img src="{{ asset($mostRecentPost->imagen) }}" alt="Blog 1"
                                class="w-full aspect-[16/10] object-cover rounded-xl mb-2">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    @if ($nextTwoRecentPosts)
                        @foreach ($nextTwoRecentPosts as $post)
                            <a href="{{ route('detalleBlog', $post->slug) }}" class="w-full block">
                                <div class="bg-colorBackgroundAzulClaro shadow-lg rounded-lg overflow-hidden flex flex-row items-center gap-4 p-4">
                                    <div class="w-[40%] min-w-[40%] flex-shrink-0">
                                        <img src="{{ asset($post->imagen) }}" alt="Blog 2"
                                            class="w-full aspect-[16/10] lg:aspect-square object-cover rounded-xl">
                                    </div>

                                    <div class="flex flex-col w-[60%] justify-center items-start">
                                        <div class="flex flex-col gap-2 w-full">
                                            <span class="text-text14 text-colorRojo font-bold">{{ $post->category->nombre }}</span>
                                            <h3 class="text-text20 lg:text-text24 font-semibold text-colorAzulOscuro line-clamp-2">
                                                {{ $post->titulo }}
                                            </h3>
                                            <p class="mt-1 text-colorParrafo text-text14 lg:text-text16 line-clamp-2">
                                                {{ $post->extracto }}
                                            </p>
                                        </div>
                                        <span class="inline-block mt-3 bg-colorBackgroundRed hover:bg-colorBackgroundRed text-white font-semibold px-4 py-2 rounded-full text-sm">Leer más</span>
                                    </div>
                                </div>
                            </a>
                        @endforeach
